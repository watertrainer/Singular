...
// NO_LRING: coefficient domain must be a field for non-global orderings
//
// other stuff:
...
,{D(jjBETTI),      BETTI_CMD,       INTMAT_CMD,     LIST_CMD      , ALLOW_PLURAL |NO_RING}
,{D(syBetti1),     BETTI_CMD,       INTMAT_CMD,     RESOLUTION_CMD, ALLOW_PLURAL |NO_RING}
,{D(jjBETTI),      BETTI_CMD,       INTMAT_CMD,     IDEAL_CMD     , ALLOW_PLURAL |NO_RING}
,{D(jjBETTI),      BETTI_CMD,       INTMAT_CMD,     MODUL_CMD     , ALLOW_PLURAL |NO_RING}
...
,{D(jjDENOMINATOR_P),DENOMINATOR_CMD, NUMBER_CMD,   POLY_CMD      , ALLOW_NC |ALLOW_RING}
,{D(jjDENOMINATOR_P),DENOMINATOR_CMD, NUMBER_CMD,   VECTOR_CMD    , ALLOW_NC |ALLOW_RING}
...
,{D(jjMINRES),     MINRES_CMD,      LIST_CMD,       LIST_CMD      , ALLOW_PLURAL |NO_RING}
,{D(jjMINRES_R),   MINRES_CMD,      RESOLUTION_CMD, RESOLUTION_CMD, ALLOW_PLURAL |NO_RING}
...
,{D(jjSYZYGY),     SYZYGY_CMD,      MODUL_CMD,      IDEAL_CMD     , ALLOW_NC |ALLOW_RING |NO_LRING}
...
,{D(jjBRACKET),   BRACKET_CMD,    POLY_CMD,       POLY_CMD,   POLY_CMD, ALLOW_NC | ALLOW_RING}
#endif
...
,{D(jjDelete_ID_IV),DELETE_CMD,   IDEAL_CMD,      IDEAL_CMD,  INTVEC_CMD, ALLOW_NC |ALLOW_RING}
,{D(jjDelete_ID), DELETE_CMD,     MODUL_CMD,      MODUL_CMD,  INT_CMD, ALLOW_NC |ALLOW_RING}
,{D(jjDelete_ID_IV),DELETE_CMD,   MODUL_CMD,      MODUL_CMD,  INTVEC_CMD, ALLOW_NC |ALLOW_RING}
,{D(lDelete),     DELETE_CMD,     LIST_CMD,       LIST_CMD,   INT_CMD, ALLOW_NC |ALLOW_RING}
,{D(lDeleteIV),   DELETE_CMD,     LIST_CMD,       LIST_CMD,   INTVEC_CMD, ALLOW_NC |ALLOW_RING}
...
,{D(jjDIM2),      DIM_CMD,        INT_CMD,        IDEAL_CMD,  IDEAL_CMD, ALLOW_PLURAL |ALLOW_RING}
,{D(jjDIM2),      DIM_CMD,        INT_CMD,        MODUL_CMD,  IDEAL_CMD, ALLOW_PLURAL |ALLOW_RING}
...
,{D(jjFAREY_ID),  FAREY_CMD,      SMATRIX_CMD,    SMATRIX_CMD, BIGINT_CMD, ALLOW_PLURAL |NO_RING}
...
,{D(jjMODULO),    MODULO_CMD,     MODUL_CMD,      IDEAL_CMD,  IDEAL_CMD, ALLOW_NC |ALLOW_RING}
,{D(jjMODULO),    MODULO_CMD,     MODUL_CMD,      MODUL_CMD,  MODUL_CMD, ALLOW_NC |ALLOW_RING}
...
,{D(jjPRUNE_MAP), PRUNE_MAP_CMD,  MODUL_CMD,      MODUL_CMD,  IDHDL,      ALLOW_PLURAL |ALLOW_RING}
...
,{D(jjSTD_HILB),  STD_CMD,        IDEAL_CMD,      IDEAL_CMD,  BIGINTVEC_CMD, ALLOW_PLURAL |NO_RING}
...
,{D(jjBRACKET_REC),    BRACKET_CMD,POLY_CMD,   POLY_CMD,   POLY_CMD,   INT_CMD, ALLOW_NC | ALLOW_RING}
#endif
...
#endif
,{D(jjELIMIN_HILB),    ELIMINATION_CMD,IDEAL_CMD, IDEAL_CMD, POLY_CMD, BIGINTVEC_CMD, NO_NC |NO_RING}
,{D(jjELIMIN_HILB),    ELIMINATION_CMD,MODUL_CMD, MODUL_CMD, POLY_CMD, BIGINTVEC_CMD, NO_NC |NO_RING}
...
,{D(jjHILBERT3),       HILBERT_CMD,BIGINTVEC_CMD, IDEAL_CMD,  INT_CMD,    INTVEC_CMD, ALLOW_PLURAL | ALLOW_RING | NO_ZERODIVISOR}
,{D(jjHILBERT3),       HILBERT_CMD,BIGINTVEC_CMD, MODUL_CMD,  INT_CMD,    INTVEC_CMD, ALLOW_PLURAL | ALLOW_RING | NO_ZERODIVISOR}
,{D(jjHILBERT3Qt),     HILBERT_CMD,NONE,       IDEAL_CMD,  RING_CMD,   STRING_CMD, ALLOW_PLURAL | ALLOW_RING | NO_ZERODIVISOR}
,{D(jjHILBERT3Qt),     HILBERT_CMD,NONE,       MODUL_CMD,  RING_CMD,   STRING_CMD, ALLOW_PLURAL | ALLOW_RING | NO_ZERODIVISOR}
...
,{D(jjHOMOG_W_M),      HOMOG_CMD,  INT_CMD,    MODUL_CMD,  INTVEC_CMD, INTVEC_CMD, ALLOW_PLURAL |ALLOW_RING}
...
,{D(jjLIFTSTD_SYZ),    LIFTSTD_CMD,IDEAL_CMD,  IDEAL_CMD,  MATRIX_CMD, MODUL_CMD, ALLOW_NC |ALLOW_RING}
,{D(jjLIFTSTD_SYZ),    LIFTSTD_CMD,MODUL_CMD,  MODUL_CMD,  MATRIX_CMD, MODUL_CMD, ALLOW_NC |ALLOW_RING}
,{D(jjLIFTSTD_ALG),    LIFTSTD_CMD,IDEAL_CMD,  IDEAL_CMD,  MATRIX_CMD, STRING_CMD, ALLOW_NC |ALLOW_RING}
,{D(jjLIFTSTD_ALG),    LIFTSTD_CMD,MODUL_CMD,  MODUL_CMD,  MATRIX_CMD, STRING_CMD, ALLOW_NC |ALLOW_RING}
...
,{D(jjMRES_MAP),       MRES_MAP_CMD,RESOLUTION_CMD,IDEAL_CMD,INT_CMD,  SMATRIX_CMD, ALLOW_PLURAL |ALLOW_RING}
,{D(jjMRES_MAP),       MRES_MAP_CMD,RESOLUTION_CMD,MODUL_CMD,INT_CMD,  SMATRIX_CMD, ALLOW_PLURAL |ALLOW_RING}
...
,{D(jjSTD_HILB_W),     STD_CMD,    IDEAL_CMD,  IDEAL_CMD,  BIGINTVEC_CMD,INTVEC_CMD, ALLOW_PLURAL |NO_RING}
,{D(jjSTD_HILB_W),     STD_CMD,    MODUL_CMD,  MODUL_CMD,  BIGINTVEC_CMD,INTVEC_CMD, ALLOW_PLURAL |NO_RING}
,{D(jjSUBST_Bu),       SUBST_CMD,  ANY_TYPE,   DEF_CMD,    POLY_CMD,   BUCKET_CMD , ALLOW_NC |ALLOW_RING}
,{D(jjSUBST_P),        SUBST_CMD,  POLY_CMD,   POLY_CMD,   POLY_CMD,   POLY_CMD , ALLOW_NC |ALLOW_RING}
,{D(jjSUBST_P),        SUBST_CMD,  VECTOR_CMD, VECTOR_CMD, POLY_CMD,   POLY_CMD , ALLOW_NC |ALLOW_RING}
,{D(jjSUBST_Id),       SUBST_CMD,  IDEAL_CMD,  IDEAL_CMD,  POLY_CMD,   POLY_CMD , ALLOW_NC |ALLOW_RING}
,{D(jjSUBST_Id),       SUBST_CMD,  MODUL_CMD,  MODUL_CMD,  POLY_CMD,   POLY_CMD , ALLOW_NC |ALLOW_RING}
,{D(jjSUBST_Id),       SUBST_CMD,  MATRIX_CMD, MATRIX_CMD, POLY_CMD,   POLY_CMD , ALLOW_NC |ALLOW_RING}
,{D(jjSUBST_Id_I),     SUBST_CMD,  MATRIX_CMD, MATRIX_CMD, POLY_CMD,   INT_CMD  , ALLOW_NC |ALLOW_RING}
...
,{D(jjMODULO4),   MODULO_CMD,      MODUL_CMD,           4      , ALLOW_NC |ALLOW_RING}
...
,{D(jjCALL3ARG),  SUBST_CMD,       NONE/*set by p*/,   3       , ALLOW_NC |ALLOW_RING}
,{D(jjSUBST_M),   SUBST_CMD,       NONE/*set by p*/,   -2      , ALLOW_NC |ALLOW_RING}
